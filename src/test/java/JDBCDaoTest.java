...
public class JDBCDaoTest {
    ...
    JDBCDao jdbcDao = JDBCDao.startWorkWithDatabase();
    ...
    public void findByIdUser() {
        ...
        //создаем список expected и заполняем его данными нашего метода
        User idUser = jdbcDao.findByIdUser(1);
    ...
    public void saveUser(){
        ...
        Assert.assertTrue(jdbcDao.saveUser(user));
    }
//    @Test
...
//    }
    ...
    public void findAllProducts() {
        ...
        List<Products> expected = jdbcDao.findAllProducts();

        //создаем список actual в него помещаем данные для сравнения
        //то что мы предполагаем метод должен вернуть
        List<Products> actual = jdbcDao.findAllProducts();
    ...
    public void findByIdProducts() {
        ...
        //создаем список expected и заполняем его данными нашего метода
        Products idProducts = jdbcDao.findByIdProducts(1);
    ...
    public void saveProducts(){
        ...
        Assert.assertTrue(jdbcDao.saveProducts(products));
    }
//    @Test
...
//    }
    ...
    public void findShopById() {
        ...
        //создаем список expected и заполняем его данными нашего метода
        Shop_cart idShop = jdbcDao.findShopById(1);
    ...
    public void findOrdersById() {
        ...
        //создаем список expected и заполняем его данными нашего метода
        Orders idOrders = jdbcDao.findOrdersById(1);
